...
const command = new Command()
  ...
  .option(
    '--git-host-variant [gitHostVariant]',
    'The git host variant. Git-cliff supports 4 hosting websites, GitHub, GitLab, Gitea, and BitBucket. By setting this option you control which api is used by git-cliff. Defaults to "github" for backwards compatibility.'
  )
  .option(
    '--git-repo',
    [
