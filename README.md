...
Options:
  ...
  -ghrd, --github-release-draft                    Whether the release should be a draft (default: false)
  -ghrpr, --github-release-pre-release             Whether the release should be a pre-release (default: false)
  -ghrl, --github-release-latest                   Whether the release should be marked as the latest release (default: true)
